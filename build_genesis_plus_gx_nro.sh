...
NRO_OUTPUT="$BUILD_DIR/tico-genesisplusgx.nro"
ELF2NRO="$DEVKITPRO/tools/bin/elf2nro"
NACPTOOL="$DEVKITPRO/tools/bin/nacptool"

# Create NACP
NACP_FILE="$BUILD_DIR/genesis_plus_gx.nacp"
$NACPTOOL --create "tico Genesis Plus GX" "ticoverse.com" "1.0.1" "$NACP_FILE"
...
if [ -f "$NRO_OUTPUT" ]; then
    ...
    echo "Deploy to: sdmc:/tico/cores/tico-genesisplusgx.nro"
    echo "======================================"
else
    echo "Error: tico-genesisplusgx.nro not found"
    exit 1
fi
