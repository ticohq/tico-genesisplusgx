...
**Genesis Plus GX** is a highly accurate emulator for the Sega Genesis / Mega Drive, with support for related systems such as Master System, Game Gear, and Sega CD.

This fork adapts Genesis Plus GX to work with the Tico frontend and provides a standalone build for the Nintendo Switch, adding a small set of practical features while preserving the accuracy and behavior of the original emulator.

----------

## Summary

This fork focuses on making Genesis Plus GX more usable in practice without changing its core design.
